"""Stage 2: 4 parallel LLM calls for independent analysis. No niche-specific changes needed."""
...
async def _call_model(client: httpx.AsyncClient, model_key: str, prompt: str, attempt: int = 1) -> dict:
    ...
    if model_key in ("grok", "gpt", "gemini"):
        messages.append({"role": "system", "content": "You are a senior analyst. Return ONLY valid JSON, no markdown fences."})
